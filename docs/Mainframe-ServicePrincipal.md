# Mainframe Landing Zone - Setting up Service Principal
...
>[Previous](/docs/Mainframe-CreateRepository.md)
>[Next (Option (a) GitHub Actions)](/docs/Mainframe-GitHubActionsDeployment.md)
>[Next (Option (b) Azure DevOps)](/docs/Mainframe-AzureDevOpsDeployment.md)
